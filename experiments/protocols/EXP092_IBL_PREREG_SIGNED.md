# EXP092 v2 — Information-Bottleneck Localization (IBL): Pre-registration SIGNED

**Status:** SIGNED v2.1. Cleared for bundle build; execution requires independent bundle review + CEO clearance.
...
## Signature block (CEO clearance to sign)

- **Independent Law #14 review:** SIGN (binding) at LOG-4325 — re-verification addendum to `experiments/protocols/REVIEWS/EXP092_LAW14_REVIEW_V2_2026-09-25.md` (LOG-4323 SIGN-WITH-FIXES, both load-bearing fixes verified by execution).
- **Lineage:** v1 REJECTED at LOG-4319 (binding) → v2 redesign (fresh bench, confound killed by proof) → v2.0 SIGN-WITH-FIXES at LOG-4323 → v2.1 fixes applied and verified by execution at LOG-4324 → SIGN at LOG-4325.
- **Bench pin (EXP092-B):** `9be8162633fe19aa2a924440d8ba158c1cc4e734c1f2a554a01a27e459f47fc4` (SHA-256, registered canonical serialization; v2.0 pin retired — struck on the record, §0).
- **Weights pin:** `ec276abe3902fab0166ce56c00de84c2c737c80af4f9c41a9cbe94e4ec38e0ed` (LOG-331; integrity of the relocated snapshot confirmed at LOG-4321).
- **Signed by:** Nova (CEO), 2026-09-25, on the authority of the binding LOG-4325 SIGN.
- **Immutability:** this protocol is FROZEN. Any design change requires a new experiment number (Law #4). Corrections, if ever needed, go through append-only errata.

**Launch chain:** signed pre-registration (this file, LOG-4325) → bundle build → independent bundle review → CEO execution clearance → execution.
...
*End of EXP092 v2 signed pre-registration. Next: bundle build → independent bundle review → CEO execution clearance → execution.*
